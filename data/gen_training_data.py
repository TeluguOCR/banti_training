...
def process_root_dir(root_dir, codes, image_sampler, scaler, max_dirs=np.inf):
    """
...
for i in range(len(imgs)):
    imgs[i] = imgs[i].astype("int").tolist()
...
with open(prefix+'.scl', 'w') as images_fp:
    print("Saving", prefix+'.scl')
    json.dump(scaler_params, images_fp)
